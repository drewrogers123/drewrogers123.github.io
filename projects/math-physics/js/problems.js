        ...
        math: {
            algebra: [
                ...
                },
                {
                    ...
                    "answer3": "Even, since cycle decomposition has one 3‐cycle and one 2‐cycle which is even.",
                    "answer4": "Odd, because its order is 6.",
                    "correct": "answer2",
                    "solution": "From the transposition decomposition there are three transpositions; odd number implies odd parity. Official solution: odd.",
                ...
                },
                {
                    ...
                    "difficulty": 45,
                    "type": "multiple-choice",
                    "question": "Express $$\\sigma$$ (same $$\\sigma$$ as above) as a product of disjoint cycles.",
                    "answer1": "$$(1\\;3\\;4)(2\\;6)\\;(5)$$",
                    "answer2": "$$(1\\;4\\;3)(2\\;6)$$",
                    "answer3": "$$(1\\;3)(4\\;2)(5\\;6)$$",
                    "answer4": "$$(1\\;2\\;3\\;4\\;5\\;6)$$",
                    "correct": "answer1",
                    "solution": "Compute cycles: 1→3→4→1 gives (1 3 4), 2→6→2 gives (2 6), and 5 is fixed. Usually fixed points are omitted; thus $$\\sigma=(1\\;3\\;4)(2\\;6)$$ (the answer including (5) is equivalent). (Official solution: $$\\sigma=(134)(26)$$.)",
                    "tags": ["permutations", "cycle decomposition"]
                },
                {
                    "id": "mit430-2c",
                    "difficulty": 45,
                ...
                },
                {
                    ...
                    "type": "multiple-choice",
                    "question": "Is $$\\sigma$$ even or odd?",
                    "answer1": "Even, because it is a product of two disjoint cycles.",
                    "answer2": "Odd, because it can be written as a product of an odd number of transpositions.",
                ...
                },
                {
                    ...
                    "answer4": "12",
                    "correct": "answer3",
                    "solution": "Order is lcm of cycle lengths: lcm(3,2)=6, so order is 6. (Official solution: 6.)",
